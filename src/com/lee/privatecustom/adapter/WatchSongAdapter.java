...
public class WatchSongAdapter extends BaseAdapter {
    ...
    public WatchSongAdapter(Context context, List<Item> watchSongInfosList) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ViewHolder vh;
        if(convertView==null){
            convertView=inflater.inflate(R.layout.item_layout_erge_babywatch,viewGroup,false);
            vh=new ViewHolder();
        ...
        Item item = listWatchSong.get(i+1);
        Log.d("TAG","itme***55555555555= "+item.toString());
        vh.tvWatchSongName.setText(i+1+"."+item.getName());
